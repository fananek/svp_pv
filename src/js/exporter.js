    ...
    <div class="block-card">
      ...
      <div style="margin-top: 14px; margin-bottom: 12px;">
        ...
        ${(b.competencies && b.competencies.length > 0) ? b.competencies.map(compCode => {
          ...
          return `
            <div style="margin-bottom: 8px; padding: 6px 12px; background: #f8fafc; border-left: 3.5px solid #3b82f6; border-radius: 0 6px 6px 0;">
              ...
              ` : `<div style="font-size: 8.5pt; color: #9ca3af; font-style: italic; margin-left: 6px; margin-top: 2px;">Kompetenční výsledek učení nebyl specifikován.</div>`}
            </div>
          `;
      ...
      <div style="margin-top: 12px; margin-bottom: 12px;">
        ...
        ${(b.areas && b.areas.length > 0) ? b.areas.map(areaCode => {
          ...
          return `
            <div style="margin-bottom: 8px; padding: 6px 12px; background: #f8fafc; border-left: 3.5px solid #10b981; border-radius: 0 6px 6px 0;">
              ...
              ` : `<div style="font-size: 8.5pt; color: #9ca3af; font-style: italic; margin-left: 6px; margin-top: 2px;">Oborový výsledek učení nebyl specifikován.</div>`}
            </div>
          `;
